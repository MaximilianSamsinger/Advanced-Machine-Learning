...
\begin{document}
	...
	\label{sec:Taskii}
	This task is quite similar to the first one. The difference is that the $convert\_to\_features()$ function get initialized differently. How this is done is already described in \autoref{sec:Taski}. Task ii also has a highly unstable average reward, but compared to Task i the rewards seem to jitter even more. 
